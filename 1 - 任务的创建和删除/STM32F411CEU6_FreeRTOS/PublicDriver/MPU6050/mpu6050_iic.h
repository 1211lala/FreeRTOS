...
//#define MPU_IIC_SCL_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

//#define MPU_IIC_SDA_GPIO_PORT            GPIOB
//#define MPU_IIC_SDA_GPIO_PIN             GPIO_PIN_1
//#define MPU_IIC_SDA_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOB_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */
...
#define MPU_READ_SDA       HAL_GPIO_ReadPin(mpu6050_sda_GPIO_Port, mpu6050_sda_Pin) /* 读取SDA */
